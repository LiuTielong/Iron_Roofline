"""
计算使用eagle-3算法跑llama-3.1-8B模型, 能达到的performance (tokens/s)。
...
def draw_figures():
    ...
    """
    verify_times1, verify_times2, draft_times1, draft_times2 = run_eagle3()
    # 1. 短文本，batch_size=1
    draw_roofline(prefill_lengths=total_tokens, times=verify_times1, save_path="Figures/eagle3/bs1_roofline_model.png")
    draw_roofline_discount(prefill_lengths=total_tokens, verify_times=verify_times1, draft_times=draft_times1, 
                           save_path="Figures/eagle3/bs1_discounted_roofline_model.png")
    draw_acc(prefill_lengths=total_tokens, accepted_lengths=AATs, save_path="Figures/eagle3/bs1_acc.png")
    draw_combined_model(prefill_lengths=total_tokens, verify_times=verify_times1, draft_times=draft_times1, 
                        accepted_lengths=AATs, save_path="Figures/eagle3/bs1_combined_model.png")

    # 2. 短文本，batch_size=128
    draw_roofline(prefill_lengths=total_tokens, times=verify_times2, save_path="Figures/eagle3/bs128_roofline_model.png" ,batch_size=128)
    draw_roofline_discount(prefill_lengths=total_tokens, verify_times=verify_times2, draft_times=draft_times2, 
                           save_path="Figures/eagle3/bs128_discounted_roofline_model.png", batch_size=128)
    draw_acc(prefill_lengths=total_tokens, accepted_lengths=AATs, save_path="Figures/eagle3/bs128_acc.png")
    draw_combined_model(prefill_lengths=total_tokens, verify_times=verify_times2, draft_times=draft_times2, 
                        accepted_lengths=AATs, save_path="Figures/eagle3/bs128_combined_model.png", batch_size=128)
